        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="bg-muted p-8 rounded-lg border border-border">
                ...
                {contactContent.contactInfo.phone && (
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-foreground">
                      {t(contactContent.contactInfo.phone)}
                    </span>
                  </div>
                )}
                {contactContent.contactInfo.whatsapp && (
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <a
                      href={`https://wa.me/${contactContent.contactInfo.whatsapp.replace(/\s/g, '')}`}
                      target="_blank"
                ...
                {contactContent.contactInfo.address && (
                  <div className="flex items-start space-x-3 mb-4">
                    ...
                    <span className="text-foreground">
                      {t(contactContent.contactInfo.address)}
                    </span>
                  </div>
                )}
              ...
              {/* Google Maps */}
              {contactContent.contactInfo.coordinates && (
                <div className="bg-muted rounded-lg border border-border overflow-hidden">
                  <iframe
                    src={`https://www.google.com/maps?q=${contactContent.contactInfo.coordinates.lat},${contactContent.contactInfo.coordinates.lng}&hl=es&z=15&output=embed`}
                    width="100%"
                    height="300"
                    style={{ border: 0 }}
                    allowFullScreen
